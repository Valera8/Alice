...
if ($orig == 'запусти навык выбор заработка в интернете'/* || $orig == 'запусти навык подобрать работу в интернете'*/)
{
...
elseif ($opt == 'more' || $orig == 'другой выбор')
{
    ...
    $answer['response']['tts'] = 'Пожалуйста, - фриланс, - опросы, - сёрфинг!';
    $answer['response']['buttons'] = array(
        array(
...
elseif ($orig == 'скажи проверенный сайт для заработка')
{
...
elseif ($orig != 'запусти навык выбор заработка в интернете' || $orig != 'запусти навык подобрать работу в интернете' || $orig != 'писать' || $orig != 'биржа е т икс т' || $orig != 'биржа текст саль' || $orig != 'биржа адвего' || $orig != 'фотографировать' || $orig != 'фотобанк лори' || $orig != 'фотобанк отражение' || $orig != 'другой выбор' || $orig != 'скажи проверенный сайт для заработка' || $orig != 'помощь')
{
    ...
    {
        $answer['response']['text'] = 'Ошибка! Пожалуйста, повтори, или попробуй сделать выбор нажатием на кнопку!';
        $answer['response']['tts'] = 'Извини, я не расслышала! - Пожалуйста, повтори, - или лучше сделай в+ыбор нажатием на кнопку!';
        $answer['response']['buttons'] = array(
            array(
                'title' => 'Помощь',
